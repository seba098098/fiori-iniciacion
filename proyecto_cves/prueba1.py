...
def process_repository():
    ...
    print(f"\n✅ Proceso completado. Nuevos: {len(nuevos)}, Modificados: {len(modificados)}, Sin cambios: {len(sin_cambios)}")
    print(f"📄 Consolidado final: {len(consolidated_data)} CVEs guardados en '{OUTPUT_FILE}'")
